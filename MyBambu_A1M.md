...
📚 [擠出機堵塞](https://wiki.anycubic.com/zh/fdm-3d-printer/kobra-3-combo/extruder-replacement) 📚🌟 [挤出模块组件拆装指引](https://wiki.bambulab.com/zh/a1-mini/maintenance/a1-extruder) 🎵 [挤出模块拆装](https://www.bilibili.com/video/BV1UN4y1S7y9) 🎵 [擠出機視頻](https://www.youtube.com/watch?v=CLlT1RV-oJE)
...
![更換熱端](./img/a1m/BambuHotEnd-400.png)
![拆擠出機](./img/a1m/BambuExtruder-400.jpg)
...
🏯 六通 🏯 分流器 🏯 支架 🏯 AMS Lite/工具 🏯 收納 

### 🏯 六通 

- 251214 原本用 [Y型分线器](https://makerworld.com/zh/models/938395) 接外掛料架, 不過退線時 PTFE 也跟著脫落, 又不能黏死很是麻煩, 所以又換成 [六通](https://makerworld.com/zh/models/1310652) ~ 
...
### 🏯 分流器 
🌟[顺滑 Y 分流器连接器](https://makerworld.com/zh/models/18174) 和 [Smoothy 支架](https://makerworld.com/zh/models/18190)
