...
可能是連續列印了近10天, AMS 換色時, 竟然瘋了進退線不得一直空轉, 1號盒就卡在換色最後一里路, 還好停機1天重新開機就好了, 不過又發生另一個問題, 停機太久底座就分離了, 底座移位就很難救了, 只好重印~ 第二次列印又因為擦拭搭移位, 所以只好一陸炒麵下去, 最後才發現斜面換色無聊的很, 頂邊沒熨燙也不好看, 就為了一點點換色, 換料幾乎是 1:20 產生一大堆廢料和炒麵, 印右邊的時候就只用二色, 廢料也就少些 (根本沒換色還是耗了很多廢料, 這雙噴頭有點噱頭 換心酸滴), 不過換色時擦拭搭還是移位了, 好在有先見之明, 早早就用大膠帶牢牢固定擦拭搭和底座 (若擦拭搭已經移位, 再貼大膠帶就沒用了, 就只能將高層擦拭搭移除, 用炒麵換取繼續列印), 換色時炒麵也沒能把擦拭搭炒移位了, 也就勉強印到最後~
...
☘️TPU☘️ 用左噴嘴印TPU要有拆擠出機的心理準備, 如果出現擠出電機過載, 為擠出機拉力不夠, 用上置料架或直接供料可以改善供料順暢度, 如果出現擠出機堵塞, 先冷拔剪掉前段料頭, 然後用一段PETG線將將殘料擠出, 再重新進料即可, 似乎是續印時料頭因為高溫變粗了, 問題不大 TPU 反而比較不會出現斷料的慘況~ 至於列印品質左右沒差, 反而覺得裝在左邊比裝右噴嘴方便, 右噴嘴可以留給分色用, 95A可以直接走緩沖機, 再軟些的線擠出機拉力會不夠, 用上置掛架會比較好~ 
...
![251227_Saver](./img/h2d/251227_Saver.jpg)
