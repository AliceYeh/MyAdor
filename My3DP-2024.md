...
| Bambu Studio 温度預覽粉漂亮, 可惜給看不給印。  | 壞了的噴嘴 印了個寂寞發泡的温度塔, 只印了6層。  |
| ------- | ------- |
| ![Bambu Studio](./img/2024/SmartTemperatureTower_Preview.png) | ![發泡的温度塔](./img/2024/241010-FoamedTower.png) |
...
| TPU 210-250℃ 熱床80℃ 最佳温度勉強算205/210℃吧, 再往下就印空了, 往上拉絲嚴重, 為了印個溫度塔, 連擠出機都要拆, 真的粉麻煩。 | 
| ------- |
